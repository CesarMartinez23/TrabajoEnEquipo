    ...
    public partial class SegundaMigracion : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    _idCar = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    _brandCar = table.Column<string>(type: "text", nullable: false),
                    _modelCar = table.Column<string>(type: "text", nullable: false),
                    _yearCar = table.Column<string>(type: "text", nullable: false),
                    _colorCar = table.Column<string>(type: "text", nullable: false),
                    _typeCar = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Car", x => x._idCar);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DireccionContacto = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idedificio = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    nombre_edificio = table.Column<string>(type: "text", nullable: false),
                    direccion_edificio = table.Column<string>(type: "text", nullable: false),
                    cantidad_oficinas = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Student", x => x.CodStudent);
                });
